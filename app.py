...
def is_thing(image, name_of_thing, threshold):
    ...
    return ("Not " if similarity < threshold else "") + name_of_thing + " (similarity = {})".format(similarity)

demo = gr.Interface(fn=is_thing, inputs=[gr.Image(type="pil"), "text", gr.Slider(0, 1, value=0.25)], outputs=["text", ])
demo.launch()